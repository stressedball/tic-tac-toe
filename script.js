...
// const xoButtons = document.querySelectorAll('button');
// for (let button of xoButtons) {
//     button.addEventListener('click', X_O);
// }
...
function onLoad() {
    ...
    startGameButton.style.width = `${0.8 * startGameButtonContainerWidth}px`;
    startGameButton.style.height = `${0.8 * startGameButtonContainerHeight}px`;
    startGameButton.style.transform = `translate(${(startGameButtonContainerWidth - (0.8 * startGameButtonContainerWidth)) / 2}px, ${(startGameButtonContainerHeight - (0.8 * startGameButtonContainerHeight)) / 2}px)`;
    // console.log(startGameButtonHeight, startGameButtonWidth)
}
